...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2340672472ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=basdat-checkout&table=produk">`basdat-checkout`.`produk`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=basdat-login&table=users">`basdat-login`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=basdat-login&table=input_mahasiswa">`basdat-login`.`input_mahasiswa`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2e476f3a6145366d3357643f5e31386b">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="basdat-login" targettable="users">
            ...
            Waktu eksekusi kueri
                            ...
                            targetdb="basdat-checkout" targettable="produk">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">CREATE TABLE `basdat-checkout`.`produk` ( `id` INT NOT NULL AUTO_INCREMENT ,  `nama_produk` VARCHAR(100) NOT NULL ,  `harga_satuan` DOUBLE NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="basdat-checkout" targettable="produk">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `produk` (`id`, `foto`, `nama_produk`, `deskripsi_barang`, `harga_satuan`) VALUES (NULL, &#039;asset/keyby.png&#039;, &#039;Mechanical Keyboard&#039;, &#039;Some quick example text to build on the card title and make up the bulk of the card\&#039;s content.&#039;, &#039;2000&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="basdat-checkout" targettable="produk">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `produk` (`id`, `foto`, `nama_produk`, `deskripsi_produk`, `harga_satuan`) VALUES (NULL, &#039;mouse.png&#039;, &#039;Mouse&#039;, &#039;Some quick example text to build on the card title and make up the bulk of the card\&#039;s content.&#039;, &#039;1000000&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="basdat-checkout" targettable="produk">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `produk` (`id`, `foto`, `nama_produk`, `deskripsi_produk`, `harga_satuan`) VALUES (NULL, &#039;hs.png&#039;, &#039;Headset&#039;, &#039;Some quick example text to build on the card title and make up the bulk of the card\&#039;s content.&#039;, &#039;1000000&#039;);</span>
                        </div>
